<?php 
    ...
    if($_SERVER['REQUEST_METHOD']=='POST'){
        ...
        if($user_found) {
            ...
            $adduser = $con->prepare("INSERT INTO users(email, password, name, school, grade, major, mcheck, industry, club) VALUES(LOWER(:email), :password, :name, :school, :grade, :major, :mcheck, :industry, :club)");
