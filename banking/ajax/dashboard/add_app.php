...
// CHECK IF USER IS LOGGED IN
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $add_app = "INSERT INTO ib_apps(userid, uq_id, firm_name, app_name, applink, appdate) VALUES(:userid, :uq_id, :firm_name, :app_name, :applink, :appdate)";
        ...
        $appgrab = "SELECT * FROM ib_apps WHERE userid = :userid AND uq_id = :uq_id";
