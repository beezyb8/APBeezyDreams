<?php 
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $newpost = "INSERT INTO thevibe(userid, postbank, posttitle, postsubject, postdate, posttext, postschool, industry, validate) VALUES(:userid, :postbank, :posttitle, :postsubject, :postdate, :posttext, :postschool, :industry, :validate)";
        ...
        $subpost -> bindParam(':validate', $validate, PDO::PARAM_INT);
        $subpost->execute();
