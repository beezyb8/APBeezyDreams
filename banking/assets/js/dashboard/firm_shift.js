...
cowen_button.onclick = () =>{
    ...
    writeup.innerHTML = "Cowen is a full service, middle market firm. In recruiting sessions, they stress the idea that their firm is extremely disruptive, which means that they predict up and coming industries and try to get involved in them early. Some industries Cowen has jumped on recently include cannabis, crypto-currency, and electric vehicles. Cowen acquired a firm based out of Detroit in 2018, so since then, they have recruited more from U of M. Their full service capabilities allow analysts to decide between IB, Equity Capital Markets, and Debt Capital Markets teams, while the investment bankers have a generalist program. Firm culture at Cowen is predicated on honesty, open communication, and willingness to share. This starts at the top, as the CEO has made strides to create an uplifting community towards those with depression and anxiety."
    interviewsum.innerHTML = "Networking at Cowen is important, as it’s definitely easier to get an interview if you made a connection with an analyst. Plus, they care a lot about genuine interest in the firm. The first round interview is a simple screening call, where they ask a few technical questions, but mainly want to get a sense of the candidate. This is followed by a 3 interview super day with minimal technicals as well. The recruiting process is concluded with an invite-only Chop House dinner to network further before they give out offers."
