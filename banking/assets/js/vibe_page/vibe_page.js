$(document).ready(function(){
    ...
    $.ajax({
        type: 'POST',
        url: '../banking/ajax/vibe_page/vibe_ajax.php',
        data: data,
        dataType: 'json',
        async: true,
    })
...
.on('click', ".addlike", function(event) {
    ...
    $.ajax({
        type: 'POST',
        url: '../banking/ajax/vibe_page/vibe_add_like.php',
        data: addlike_data,
        dataType: 'json',
        async: true,
    })
...
.on('click', ".sublike", function(event) {
    ...
    $.ajax({
        type: 'POST',
        url: '../banking/ajax/vibe_page/vibe_remove_like.php',
        data: sublike_data,
        dataType: 'json',
        async: true,
    })
...
.on("submit", ".create_a_vibe", function(event) {
    ...
    $.ajax({
        type: 'POST',
        url: '../banking/ajax/vibe_page/vibe_post.php',
        data: vibe_post_info,
        dataType: 'json',
        async: true,
    })
