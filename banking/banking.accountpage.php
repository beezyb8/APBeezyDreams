...
<body>
       <nav class="nav_bar_sticky">
        ...
        <div class="links">
            ...
            <a href="banking.accountpage.php"><p class="innernav_txt current_nav">Your Account</p></a>
        </div>
        ...
        <div class="dropdown_links">
            ...
            <a href="banking.accountpage.php"><p class="drop_innernav_txt drop_current_nav">Your Account</p></a>
        </div>
    <div class="bodycont">
        <h1>Your Account</h1>
