...
$appsql = "SELECT * FROM ib_apps WHERE userid = :userid";
...
<body>
    <nav class="nav_bar_sticky">
        ...
        <div class="links">
            ...
            <a href="banking.applications.php"><p class="innernav_txt current_nav">Applications</p></a>
        ...
        <div class="dropdown_links">
            ...
            <a href="banking.applications.php"><p class="drop_innernav_txt drop_current_nav">Applications</p></a>
...
<script src='../banking/assets/js/applications/applied_ours.js'></script>
