...
<div class="body_div_body">
    <nav class="nav_bar_sticky">
        ...
        <div class="links">
            <a href="banking.dashboard.php"><p class="innernav_txt current_nav">Dashboard</p></a>
        ...
        <div class="dropdown_links">
            <a href="banking.dashboard.php"><p class="drop_innernav_txt drop_current_nav">Dashboard</p></a>
    ...
    <?php
        require_once "../inc/banking.footer.php";
    ...
    if($user['industry']==3){
        if($user['mcheck'] == 1) : ?>
                <script src='../banking/assets/js/dashboard/firm_shift.js'></script>
            <?php else : ?>
                <script src='../banking/assets/js/dashboard/firm_shiftneut.js'></script>
        <?php endif; }
    elseif($user['industry']==4){
            if($user['mcheck'] == 1) : ?>
                <script src='../banking/assets/js/dashboard/check4/firm_shift.js'></script>
            <?php else : ?>
                <script src='../banking/assets/js/dashboard/check4/firm_shiftneut.js'></script>
    <?php endif; } ?>
        
    <script src='../banking/assets/js/editcontact.js'></script>
    
    
    
    <!--DASBOARD-->
    <script src='../banking/assets/js/dashboard/firm_order_change.js'></script>
    <script src='../banking/assets/js/dashboard/network.js'></script>
    <script src='../banking/assets/js/dashboard/contactnotes.js'></script>
    <script src='../banking/assets/js/dashboard/update_apps.js'></script>
    <script src='../banking/assets/js/dashboard/firm_notes.js'></script>
    <script src='../banking/assets/js/dashboard/application.js'></script>
    <script src='../banking/assets/js/dashboard/addfirm.js'></script>
    <script src='../banking/assets/js/dashboard/searchbar.js'></script>
    <!--Dashboard-->
    
    
    <!--VIBE-->
    <script src='../banking/assets/js/thevibe/thevibe.js'></script>
    <script src='../banking/assets/js/thevibe/vibepull_function.js'></script>
    <!--VIBE-->
    
    <script src='../banking/assets/js/applications/applied_yours.js'></script>
    
    <script src='../banking/assets/js/drop_nav.js'></script>
</div>
<footer>
