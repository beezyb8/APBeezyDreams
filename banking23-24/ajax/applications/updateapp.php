<?php 
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $checkPermissionQuery = "SELECT * FROM ib_apps WHERE app_id = :app_id";
        ...
        if ($appOwner['userid'] !=  $userid) {
            ...
            $sqlupdateapp = "UPDATE ib_apps SET app_name = :app_name, applink = :applink, applocation = :applocation, appdate = :appdate WHERE ib_apps.app_id = :app_id";
