function UpdateFullTable(data){
    ...
    $.each(data.contacts, function(index, value){
        ...
        event_data += "<td class='contacttitle' id='"+txmarker+"'value='"+value.contact_name+"'><div class='tooltip'>"+value.contact_name+"<span class='tooltiptext'>Click to Edit</span></div></td>";
