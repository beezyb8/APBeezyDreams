...
gordan_button.forEach(element => {
    ...
    interviewsum.innerHTML = "Networking is important to secure a first round interview with Gordon Dyal & Co. That said, only one strong connection may be necessary, whereas some other banks may care more about the quantity of calls. The firm came to Ann Arbor in mid-March, and released their online applications around the same time. The first round interview is typically virtual, and mainly technical, with questions from on and off the guides. Super day candidates are flown to NYC for five 30 minute interviews, which consist of both behaviorals and complex technicals. Both the first round and super day typically include a number of mental math questions and brain teasers."
...
lincoln_button.forEach(element => {
    ...
    emailformat.innerHTML = "first.last@lincolninternational.com (ie. john.smith@lincolninternational.com)"
...
wellsfargo_button.forEach(element => {
    ...
    interviewsum.innerHTML = "Wells Fargo places a strong emphasis on recruiting candidates from southern schools such as UNC, Duke and Wake Forest. While Michigan isn’t a target school, they typically take a couple candidates each year. Wells Fargo also has strong diversity programs which lead to IB offers. The first round interview is typically a screening over the phone, which is mainly behaviorals, but may include some light technicals. The super day is typically two interviews, both including a mix of behavioral and technicals."
