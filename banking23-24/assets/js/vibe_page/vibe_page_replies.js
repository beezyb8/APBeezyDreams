...
.on('click', ".vibe_reply_btn", function(event) {
    ...
    $.ajax({
        type: 'POST',
        url: '../banking/ajax/vibe_replies/vibe_post_reply.php',
        data: reply_info,
        dataType: 'json',
        async: true,
    })
...
.on('click', ".add_rep_like", function(event) {
    ...
    $.ajax({
        type: 'POST',
        url: '../banking/ajax/vibe_replies/vibe_add_rep_like.php',
        data: addlike_data,
        dataType: 'json',
        async: true,
    })
...
.on('click', ".sub_rep_like", function(event) {
    ...
    $.ajax({
        type: 'POST',
        url: '../banking/ajax/vibe_replies/vibe_remove_rep_like.php',
        data: sublike_data,
        dataType: 'json',
        async: true,
    })
