...
$ibfirmsql = "SELECT * FROM ibfirms WHERE userid = :userid order by display_order";
$ibgetfirms_list = $con->prepare($ibfirmsql);
$ibgetfirms_list->bindParam(':userid', $userid);
$ibgetfirms_list->execute();
...
$confirmslist = $getfirms_list->fetchAll(PDO::FETCH_ASSOC);
$ibfirmslist = $ibgetfirms_list->fetchAll(PDO::FETCH_ASSOC);
...
<body>
    <nav class="nav_bar_sticky">
        ...
        <div class="links">
            ...
            <a href="consulting.allcontacts.php"><p class="innernav_txt current_nav">Network</p></a>
        ...
        <div class="dropdown_links">
            ...
            <a href="consulting.allcontacts.php"><p class="drop_innernav_txt drop_current_nav">Network</p></a>
                ...
                <form class = "js-add-contact">
                    ...
                    <div class="contact-bank-bin">
                        <select class="contact-bank-input" id="conbank" required="required">
                            ...
                            <?php foreach($confirmslist as $firm){?>
    ...
    <?php require_once "../inc/con_allct_footer.php"; ?>
