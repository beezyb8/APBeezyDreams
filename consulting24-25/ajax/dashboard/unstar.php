<?php 
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $checkPermissionQuery = "SELECT * FROM confirms WHERE uq_id = :uq_id";
        ...
        if ($firmOwner['userid'] !=  $userid) {
            ...
            $sqlupdatestar = "UPDATE confirms SET favorite = :favorite WHERE confirms.uq_id = :uq_id";
            $updatestar = $con->prepare($sqlupdatestar);
            $updatestar->bindParam(':uq_id', $uq_id, PDO::PARAM_INT);
